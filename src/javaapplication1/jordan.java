 ...
 * @author user47
 */
public class jordan extends javax.swing.JFrame {

    /**
     * Creates new form jordan
     */
    public jordan() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jordan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
